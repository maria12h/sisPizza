	...
	<div class="row">
			...
			<div class="form-group">
				...
				<select name="idcliente" id="idcliente" class="form-control selectpicker" data-live-search="true">
					@foreach($cliente as $clie)
						<option value="{{$clie->idcliente}}">{{$clie->nombre}} {{$clie->apellidos}}</option>
					@endforeach
				</select>
			</div>
		</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<div class="form-group">
				...
				<input class="form-control" required value="{{old('numeroComprobante')}}" type="text" name="numeroComprobante" placeholder="Numero Comprobante ..."></input>
			</div>
		</div>
	</div>
	<div class="row">
					...
					<div class="form-group">
						...
						<select name="pidproducto" class="form-control selectpicker" id="pidproducto" data-live-search="true">
							...
							@foreach($producto as $art)
								<option value="{{$art->idproducto}}">{{$art->nombre}}</option>
							@endforeach
						</select>
					</div>
				</div>
